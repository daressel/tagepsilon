...
export default [
  ...
  {
    title: 'Металлопрокат.',
    images: imagesConstructor('metall_saling'),
    shortName: 'Продажа металла',
    description:
      'Металлопрокат – это изделия из разных металлов и сплавов, получаемые методом прокатывания на специальных станках. Листовой металлопрокат – это холодно- и горячекатаные листы, полосы, рулоны; Сортовой прокат, который может быть простым (круг, квадрат и др.) и фасонным (рельсы, швеллеры, уголки и т. д.).',
    altName: 'metall_saling',
    from: 'additional',
  },
  {
    title: 'Тендерное сопровождение.',
    images: imagesConstructor('tender_support'),
    shortName: 'Тендерное сопровождение',
    description: `
    Тендерное сопровождение - поможем подготовить и подать заявку. Пройдём все этапы закупки вместе с вами, научим участвовать и побеждать в торгах.
    Проведём предварительный анализ требований и документации тендера.
    Поможем получить электронную подпись и пройти аккредитацию для участия в торгах.
    Подготовим комплект документов для участия, включая заполнение характеристик по вашему товару.
    Подадим заявку на площадке, возьмём ответственность за допуск на себя.
    Поможем при участии  в аукционе, согласовании и подписании контракта.
    Проведём вас через все этапы закупки и научим участвовать в торгах.`,
    altName: 'tender_support',
    from: 'additional',
  },
  // {
